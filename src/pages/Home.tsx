...
import TransactionFeed from '../components copy/TransactionFeed';
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        <p className="text-slate-300 text-lg">Loading currency rates...</p>
      </div>
    );
  }
  ...
  if (error || !rates) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        <div className="bg-slate-900/80 border border-red-500/30 rounded-xl px-6 py-4">
